...
@Repository
public interface ProjectRepositorio extends JpaRepository<EmployeeProjects, Long>{
    ...
    List<EmployeeProjects> findAllProjects();
	...
	@Query("SELECT new com.gestion.empleados.dto.ResponseProjectDTO(p.id, p.nombreProyecto, p.fechaInicio, p.fechaFin, " +
	    ...
	    List<ResponseProjectDTO> getEmployeeProjectsByParams(@Param("nombreProyecto") String nombreProyecto,
